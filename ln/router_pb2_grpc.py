...
class RouterStub:
    ...
    def __init__(self, channel):
        ...
        self.XFindBaseLocalChanAlias = channel.unary_unary(
                ...
                _registered_method=True)
        self.DeleteForwardingHistory = channel.unary_unary(
                '/routerrpc.Router/DeleteForwardingHistory',
                request_serializer=router__pb2.DeleteForwardingHistoryRequest.SerializeToString,
                response_deserializer=router__pb2.DeleteForwardingHistoryResponse.FromString,
                _registered_method=True)
...
class RouterServicer:
    ...
    def DeleteForwardingHistory(self, request, context):
...
def add_RouterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeleteForwardingHistory': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteForwardingHistory,
                    request_deserializer=router__pb2.DeleteForwardingHistoryRequest.FromString,
                    response_serializer=router__pb2.DeleteForwardingHistoryResponse.SerializeToString,
            ),
    }
...
class Router:
    ...
    @staticmethod
    def DeleteForwardingHistory(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/routerrpc.Router/DeleteForwardingHistory',
            router__pb2.DeleteForwardingHistoryRequest.SerializeToString,
            router__pb2.DeleteForwardingHistoryResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
