...
class LightningStub:
    ...
    def __init__(self, channel):
        ...
        self.SendOnionMessage = channel.unary_unary(
                ...
                request_serializer=lightning__pb2.SendOnionMessageRequest.SerializeToString,
                response_deserializer=lightning__pb2.SendOnionMessageResponse.FromString,
                _registered_method=True)
        self.SubscribeOnionMessages = channel.unary_stream(
                '/lnrpc.Lightning/SubscribeOnionMessages',
                request_serializer=lightning__pb2.SubscribeOnionMessagesRequest.SerializeToString,
                response_deserializer=lightning__pb2.OnionMessageUpdate.FromString,
                _registered_method=True)
...
class LightningServicer:
    ...
    def SubscribeOnionMessages(self, request, context):
...
def add_LightningServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendOnionMessage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=lightning__pb2.SendOnionMessageRequest.FromString,
                    response_serializer=lightning__pb2.SendOnionMessageResponse.SerializeToString,
            ),
            'SubscribeOnionMessages': grpc.unary_stream_rpc_method_handler(
                    servicer.SubscribeOnionMessages,
                    request_deserializer=lightning__pb2.SubscribeOnionMessagesRequest.FromString,
                    response_serializer=lightning__pb2.OnionMessageUpdate.SerializeToString,
            ),
...
class Lightning:
    ...
    def SendOnionMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/lnrpc.Lightning/SendOnionMessage',
            lightning__pb2.SendOnionMessageRequest.SerializeToString,
            lightning__pb2.SendOnionMessageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    @staticmethod
    def SubscribeOnionMessages(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/lnrpc.Lightning/SubscribeOnionMessages',
            lightning__pb2.SubscribeOnionMessagesRequest.SerializeToString,
            lightning__pb2.OnionMessageUpdate.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
